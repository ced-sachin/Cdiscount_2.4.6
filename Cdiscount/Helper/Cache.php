...
class Cache extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const CACHE_KEY_IDENTIFIER = 'ced_cdiscount_';
    ...
    public function getValue($key)
    {
        ...
        return $value === false ? null : \Magento\Framework\Serialize\SerializerInterface::unserialize($value);
    }
    ...
    public function setValue($key, $value, array $tags = [], $lifeTime = null)
    {
        ...
        $this->cache->save(\Magento\Framework\Serialize\SerializerInterface::serialize($value), $cacheKey, $preparedTags, (int)$lifeTime);
    }
