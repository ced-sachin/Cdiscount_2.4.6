...
class Config extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getFeedsCronStatus()
    {
        $cronResync = $this->scopeConfigManager->getValue(
            'cdiscount_config/cdiscount_cron/resync_cron'
        );
        return $cronResync;
    }
    ...
    public function getShippingMethods()
    {
        ...
        if (!empty($shippingMethod)) {
            $unserializedShippingMethods = \Magento\Framework\Serialize\SerializerInterface::unserialize($shippingMethod);
    ...
    public function getAdditionalFeeSku()
    {
        $additionSku = $this->scopeConfigManager->getValue(
            'cdiscount_config/cdiscount_product/additional_fee'
        );
        return $additionSku;
    }
    ...
    {
        $shipmentMethod = $this->scopeConfigManager
            ->getValue("cdiscount_config/cdiscount_order/shipment_method");
        if (empty($shipmentMethod)) {
            $shipmentMethod = 'shipbycdiscount_shipbycdiscount';
        }
