...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    {
        /**
         * @var \Magento\Backend\Model\View\Result\Page $pagefactory
         */
        $id = $this->cdiscountAttributes->getCollection()->load()->getFirstItem()->getId();
        if (!empty($id)) {
            return $this->resultRedirectFactory->create()
            ->setPath('cdiscount/sizes/edit', ['id' => $id]);
        }
